...
public class HtmlProducerFactoryCapabilityFactory implements CapabilityFactory<ProducerFactoryRequirement, Object> {
	...
	public CompletionStage<Iterable<CapabilityProvider<Object>>> create(
		...
		HtmlProducerFactory factory = new HtmlProducerFactory(requirement.context());
