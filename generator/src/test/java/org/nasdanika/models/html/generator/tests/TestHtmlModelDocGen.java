package org.nasdanika.models.html.generator.tests;
 ...
 *
 */
public class TestHtmlModelDocGen {
	
	@Test
	public void testGenerateHtmlModelDoc() throws IOException, DiagnosticException {
		List<EPackage> ePackages = Arrays.asList(EcorePackage.eINSTANCE, NcorePackage.eINSTANCE, ExecPackage.eINSTANCE, HtmlPackage.eINSTANCE);
		...
		EcoreGenHtmlProcessorsFactory ecoreGenExecProcessorFactory = new EcoreGenHtmlProcessorsFactory(context);		
		...
		Map<EPackage, URI> packageURIMap = Map.ofEntries(
			...
			Map.entry(HtmlPackage.eINSTANCE, baseActionURI)	
		);
				...
				if (element instanceof EObjectNode) {
					...
					if (target == topLevelPackage) {
						...
						if (processor instanceof WidgetFactory) {
							...
							if (topLevelPackage == HtmlPackage.eINSTANCE) { 							
		...
		File output = new File(actionModelsDir, "html.xmi");
		...
		String siteMapDomain = "https://html.models.nasdanika.org";		
